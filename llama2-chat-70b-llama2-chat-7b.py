...
if __name__ == '__main__':
    pos_name, neg_name = "llama-2-chat-70b", "llama-2-chat-7b"
    ...
    for domain in data_name_list:
        ...
        for index in range(len(topics)): 
            if domain == "environment" and index in [0]:
              continue
            pos_db_list = []
            neg_db_list = []
            ...
            neg_deb1_chunk = poe_reply(neg_role + pt_state, "Llama-2-7b")
            ...
            neg_deb2 = poe_reply(m2_neg, "Llama-2-7b", chatId=neg_chatId)["text"]
            print(neg_deb2)
            ...
            neg_deb3 = poe_reply(m3_neg, "Llama-2-7b", chatId=neg_chatId)["text"]
            print(neg_deb3)
            ...
            neg_deb4 = poe_reply(m4_neg, "Llama-2-7b", chatId=neg_chatId)["text"]
            print(neg_deb4)
            ...
            neg_deb5 = poe_reply(m5_neg, "Llama-2-7b", chatId=neg_chatId)["text"]
            print(neg_deb5)
            ...
            with open('results-70b-7b/'+pos_name + "_" + neg_name + "_" + domain + "_" + file_names[index] + "_db2.json", "w") as wfile:
                json.dump(db_dic, wfile, indent=4)
            
            poe_client.delete_chat("Llama-2-70b", chatId=pos_chatId)
            poe_client.delete_chat("Llama-2-7b", chatId=neg_chatId)