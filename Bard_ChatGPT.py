...
bard_token_1PSID = "bwilUFw-bQHHIBSmg17ZoHMLPI8961nOKJppK0qx0bOG9WDfthv2M9Clh4keWQRV4Cr1KA."
bard_token_1PSIDTS = "sidts-CjIB3e41hRYhhJ28hSL1ijCRxK-RDAdY5zxYFFdxhtOxRuuh-45q-9qtW4i8AO5xJxu3nhAA"
bard_chatbot = Chatbot(bard_token_1PSID, bard_token_1PSIDTS)
encoding = tiktoken.encoding_for_model("gpt-3.5-turbo")


def chatbot_bard(message=''):
    data = bard_chatbot.ask(message)
    # print(data)
...
if __name__ == '__main__':
    pos_name, neg_name = "Bard", "ChatGPT"
    ...
    for domain in data_name_list:
        ...
        for index in range(len(topics)): 
            if domain == "environment" and index in [0,1,2,3]:
              continue
            bard_chatbot = Chatbot(bard_token_1PSID, bard_token_1PSIDTS)
            ...
            print("##### Bard")
            pos_deb1 = chatbot_bard(pos_role + pt_state)
            ...
            with open('results-bard-chatgpt/'+pos_name + "_" + neg_name + "_" +domain + "_" + file_names[index] + "_db2.json", "w") as wfile:
