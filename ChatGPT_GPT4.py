...
if __name__ == '__main__':
    pos_name, neg_name = "ChatGPT", "GPT4"
    ...
    for domain in data_name_list:
        ...
        for index in range(len(topics)): 
            ...
            # pos_deb1 = chatbot_Dragonfly(pos_role + pt_state, chat_break=True) # pos, statement
            print("##### chatGPT ")
            m1_pos_list = [
                {"role": "system", "content": pos_role},
                {"role": "user", "content": pt_state},
            ]
            pos_deb1 = chatGPT35(m1_pos_list)
            ...
            neg_deb1 = chatGPT4(m1_neg_list) # neg, statement
            ...
            # pos_deb2 = chatbot_Dragonfly(m2_pos)
            print("##### chatGPT35 ")
            m2_pos_list = [
                {"role": "system", "content": pos_role},
                {"role": "user", "content": pt_state},
            ...
            pos_deb2 = chatGPT35(m2_pos_list)
            ...
            # pos_deb3 = chatbot_Dragonfly(m3_pos) # pos, second-free-debate; with neg-statement
            print("##### chatGPT35")
            m3_pos_list = [
                {"role": "system", "content": pos_role},
                {"role": "user", "content": pt_state},
            ...
            pos_deb3 = chatGPT35(m3_pos_list)
            ...
            # pos_deb4 = chatbot_Dragonfly(m4_pos)
            print("##### chatGPT35")
            m4_pos_list = [
                {"role": "system", "content": pos_role},
                {"role": "user", "content": pt_state},
            ...
            pos_deb4 = chatGPT35(m4_pos_list)
            ...
            # pos_deb5 = chatbot_Dragonfly(m5_pos)
            print("##### chatGPT35")
            m5_pos_list = [
                {"role": "system", "content": pos_role},
                {"role": "user", "content": pt_state},
            ...
            pos_deb5 = chatGPT35(m5_pos_list)
            ...
            with open('results/'+pos_name + "_" + neg_name + "_" +domain + "_" + file_names[index] + "_db2.json", "w") as wfile:
