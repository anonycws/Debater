...
if __name__ == '__main__':
    pos_name, neg_name = "palm", "llama-2-chat-70b"
    ...
    for domain in data_name_list:
        if domain in ["education", "social", "fun filled", "leisure", "environment"]:
            continue
        print("\n\n\n\nstart domain: " + domain + "\n\n\n")
        ...
        for index in range(len(topics)): 
            if domain == "family" and index in [0,1,2]:
                continue
            pos_db_list = []
            neg_db_list = []
            ...
            print("##### palm")
            pos_deb1_chunk = poe_reply(pos_role + pt_state, "Google-PaLM")
            ...
            pos_deb2 = poe_reply(m2_pos, "Google-PaLM", chatId=pos_chatId)["text"]
            print(pos_deb2)
            ...
            pos_deb3 = poe_reply(m3_pos, "Google-PaLM", chatId=pos_chatId)["text"]
            print(pos_deb3)
            ...
            pos_deb4 = poe_reply(m4_pos, "Google-PaLM", chatId=pos_chatId)["text"]
            print(pos_deb4)
            ...
            pos_deb5 = poe_reply(m5_pos, "Google-PaLM", chatId=pos_chatId)["text"]
            print(pos_deb5)
            ...
            with open('results-palm-70b/'+pos_name + "_" + neg_name + "_" + domain + "_" + file_names[index] + "_db2.json", "w") as wfile:
                json.dump(db_dic, wfile, indent=4)
            
            poe_client.delete_chat("Google-PaLM", chatId=pos_chatId)
